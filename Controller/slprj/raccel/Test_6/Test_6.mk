...
MODEL               = Test_6
MODULES             = Test_6_capi.c Test_6_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c 
MAKEFILE            = Test_6.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/Asus/DOCUME~1/Exoskeleton MATLAB/MYVERS~1/Controller
...
MODELLIB                  = Test_6lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Test_6_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/Test_6 \
	-I$(START_DIR) \
